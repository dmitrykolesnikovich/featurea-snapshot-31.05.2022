...
fun testEncodeToShortArray() {
    ...
    println(
        shortArrayOf(12601, 12644, 13369, 25393, 14384, 24931, 24882, 25909).encodeToByteArray(Encoding.BIG_ENDIAN)
            .toString(Charset.forName("ISO-8859-1"))
    )
    println(
        shortArrayOf(13880, 14436, 26166, 14384, 25910, 12344, 13872, 14434).encodeToByteArray(Encoding.BIG_ENDIAN)
            .toString(Charset.forName("ISO-8859-1"))
    )
}
