...
fun TreeTableColumn<*,*>.toTornadoColumn() = TornadoFXTreeTableColumn(this)

fun TableColumn<*,*>.toTornadoColumn() = TornadoFxNormalTableColumn(this)
...
class TornadoFxNormalTableColumn(override val column: TableColumn<*, *>) :
    TornadoFXColumn<TableColumn<*, *>> {
    override var minWidth: Double
        get() = column.minWidth
        set(value) {
            column.minWidth = value
