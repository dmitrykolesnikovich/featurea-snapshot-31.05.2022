...
class TornadoFXTreeTableResizeFeatures(val param: TreeTableView.ResizeFeatures<out Any>) :
    TornadoFXResizeFeatures<TreeTableColumn<*, *>, TreeTableView<*>> {
    override val column = param.column?.toTornadoColumn()
    override val table = param.table.toTornadoFXTable()
    override val delta: Double get() = param.delta
}

class TornadoFxTableResizeFeatures(val param: TableView.ResizeFeatures<out Any>) :
    TornadoFXResizeFeatures<TableColumn<*, *>, TableView<*>> {
