...
///
@objc public class Socket: NSObject, SocketReader, SocketWriter {
	...
	///			unix = AF_UNIX
	///
    @objc public enum ProtocolFamily : Int32 {
	...
	///
    @objc public enum SocketType : Int32 {
	...
	///
	@objc public enum SocketProtocol: Int32 {
	...
	///
	@objc public internal(set) var isConnected: Bool = false
	...
	///
	@objc public class func create(family: ProtocolFamily = .inet, type: SocketType = .stream, proto: SocketProtocol = .tcp) throws -> Socket {
	...
	///
	@objc public func connect(to host: String, port: Int32, timeout: UInt = 0, familyOnly: Bool = false) throws {
	...
	@objc public func objc_read(into data: NSMutableData) throws -> NSNumber {
		let result = try read(into: data)
	...
	@objc public func objc_write(from data: NSData) throws -> NSNumber {
		let result = try write(from: data)
		return NSNumber(value: result)
	}
